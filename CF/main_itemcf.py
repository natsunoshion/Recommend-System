...
class CollaborativeFiltering:
    ...
    def collaborative_filtering_bias(self):
        predicted_ratings = []
        for index, row in tqdm(enumerate(self.valid_data.values), total=len(self.valid_data.values), desc="Collaborative Filtering Bias"):
            ...
            if index % 500 == 0 and index != 0:
                ...
                logging.info(f"RMSE: {calculate_rmse(predicted_ratings, self.valid_data['score'][:index + 1])}")
